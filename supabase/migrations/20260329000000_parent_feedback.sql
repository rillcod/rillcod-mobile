...
drop policy if exists "Parents can insert own feedback" on public.parent_feedback;
...
drop policy if exists "Parents can view own feedback" on public.parent_feedback;
...
drop policy if exists "Staff can view all feedback" on public.parent_feedback;
...
drop policy if exists "Staff can update feedback status" on public.parent_feedback;
