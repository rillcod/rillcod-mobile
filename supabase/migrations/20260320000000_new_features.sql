...
DROP POLICY IF EXISTS "engage_posts_select" ON public.engage_posts;
CREATE POLICY "engage_posts_select" ON public.engage_posts
  FOR SELECT USING (auth.role() = 'authenticated');

-- Only owner can insert their own posts
DROP POLICY IF EXISTS "engage_posts_insert" ON public.engage_posts;
...
DROP POLICY IF EXISTS "engage_posts_update" ON public.engage_posts;
CREATE POLICY "engage_posts_update" ON public.engage_posts
  FOR UPDATE USING (auth.role() = 'authenticated');

-- Only owner can delete
DROP POLICY IF EXISTS "engage_posts_delete" ON public.engage_posts;
