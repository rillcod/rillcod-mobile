...
DROP POLICY IF EXISTS "Users can view their own batches or admin can view all" ON "public"."registration_batches";
...
DROP POLICY IF EXISTS "Admins and teachers can insert batches" ON "public"."registration_batches";
...
DROP POLICY IF EXISTS "Users can view results for batches they can see" ON "public"."registration_results";
...
DROP POLICY IF EXISTS "Admins and teachers can insert results" ON "public"."registration_results";
