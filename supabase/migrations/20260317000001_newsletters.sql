...
DROP POLICY IF EXISTS "Admins can manage delivery" ON newsletter_delivery;
...
DROP POLICY IF EXISTS "Users can view their newsletters" ON newsletters;
...
DROP POLICY IF EXISTS "Users can view/update their delivery status" ON newsletter_delivery;
